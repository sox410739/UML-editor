...
public class AddCompositionLineListener extends UMLListener {
	private Line line;				// 當前的線物件
	private boolean isConnecting;	// 是否正在連線
	private BasicObject fromObject;	// 連線時的起點物件
	
	public AddCompositionLineListener(Canvas canvas) {
		super(canvas);
		this.line = null;
	...
	public void mousePressed(MouseEvent e) {
		...
		this.line = new CompositionLine(this.fromObject.closeTo(x, y), new Point(x, y));
